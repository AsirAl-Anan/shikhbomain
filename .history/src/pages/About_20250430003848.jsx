...
const About = () => {
  ...
  const teamMembers = [
    {
      id: 1,
      name: 'Syed Asir Al Anan BinAkber',
      position: 'Lead AI Educator, BanglaLearn',
      image: '/team-member-1.jpg',
    },
    {
      id: 2,
      name: 'Rahul Khan',
      position: 'Mathematics Specialist, BanglaLearn',
      image: '/team-member-2.jpg',
    },
    {
      id: 3,
      name: 'Priya Chowdhury',
      position: 'Science Curriculum Director, BanglaLearn',
