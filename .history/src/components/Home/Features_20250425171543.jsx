...
const Features = ({ scrollY }) => {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-20 md:py-32 bg-gradient-to-b dark:from-[#161b22] to-[#0d1117]"
    >
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 text-center">
          <button className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-medium py-3 px-8 rounded-md transition-all duration-300 transform hover:scale-105">
